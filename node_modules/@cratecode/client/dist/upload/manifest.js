                ...
                case "lesson": {
                    ...
                    if (!(lessonClass in classMap) && lessonClass !== null)
                        throw new Error("class must be null or one of [" +
                            ...
                            "]!");
                    const lessonID = yield (0, lesson_1.handleLesson)(state, id, name, spec, extends1 ? Path.join(templates, extends1) : null, classMap[lessonClass] || 0, Path.dirname(manifest));
