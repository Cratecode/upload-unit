...
export declare const websockets: WebSocket[];
/**
 ...
 */
export declare function handleLesson(state: State, id: string, name: string, unit: string | null, spec: string | null, extendsTemplate: string | null, lessonClass: number, dir: string): Promise<string>;
