 ...
 */
export declare function handleLesson(state: State, id: string, name: string, unit: string | null, spec: string | null, templateDir: string | null, lessonClass: number, dir: string): Promise<string>;
