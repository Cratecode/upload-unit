 ...
 */
function handleLesson(state, id, name, unit, spec, templateDir, lessonClass, dir) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (fs.existsSync(Path.join(dir, "config.json"))) {
            configData = JSON.parse(fs.readFileSync(Path.join(dir, "config.json"), "utf-8"));
        }
        ...
        if (templateDir && fs.existsSync(Path.join(templateDir, "config.json"))) {
            const templateConfig = JSON.parse(fs.readFileSync(Path.join(templateDir, "config.json"), "utf-8"));
            // This will handle configData being null.
            configData = (0, defaultsDeep_1.default)(configData, templateConfig);
        }
